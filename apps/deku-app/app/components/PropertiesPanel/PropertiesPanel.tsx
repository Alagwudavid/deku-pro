        ...
        {layoutOpen && (
          <div className="px-4 pb-2 space-y-3">
            ...
            <div className="flex items-center gap-2">
              <input
                type="number"
                className="bg-[#23262F] text-xs text-white rounded-lg border border-[#23262F] py-1 px-2 w-16"
                defaultValue={10}
              />
              <input
                type="range"
                ...
                max={100}
                defaultValue={10}
                className="flex-1 accent-[#377DFF]"
              />
            </div>
            {/* Padding */}
            <div className="flex gap-2">
              <input
                type="number"
                className="bg-[#23262F] text-xs text-white rounded-lg border border-[#23262F] py-1 px-2 w-full"
                defaultValue={0}
              />
  ...
  return (
    <div className="flex items-center justify-between px-4 pt-4 pb-2">
      <div className="flex items-center gap-1">
        <span className="text-xs text-[#A1A1AA] font-semibold tracking-wide">
          {label}
        </span>
        <FiInfo className="text-[#6B7280] text-xs" />
      </div>
...
function ActiveButton({
  ...
  return (
    <button
      className={`flex-1 rounded-lg border border-[#23262F] py-1 px-2 text-xs font-medium transition
        ${active ? "bg-[#23262F] text-white" : "bg-[#23262F] text-[#6B7280]"}
      `}
    >
      {children}
    </button>
